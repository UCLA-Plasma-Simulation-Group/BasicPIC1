...
global plot_name, plot_loc, plot_data, plot_data2, sim_data
global sdt, stend, snx, snmv, snpx
...
def update_gui(plotloc,simdata):
   global root, plot_loc, sim_data, sdt, stend, snx, snmv, snpx
   """
...
def update_plot(pname,plotdata=None,plotdata2=None):
   ...
   global plot_data, plot_data2
#request plot
   plot_name = pname
   if rtime >= ftime or rstatus==0:
      plot_data = plotdata
      plot_data2 = plotdata2
